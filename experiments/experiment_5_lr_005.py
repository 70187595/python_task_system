"""
Эксперимент 5: Обучение модели с высоким learning_rate=0.05
Цель: Проверить влияние быстрого обучения на качество и стабильность
"""
...
def main():
    print("🧪 ЭКСПЕРИМЕНТ 5: learning_rate=0.05")
    print("=" * 60)
    ...
    # Создаем сеть с высоким learning rate
    ...
    print(f"   Learning rate: 0.05 (высокий)")
    print(f"   Epochs: 2000")
    ...
    network.save_model('experiments/results/model_exp5_lr005.json')
    
    with open('experiments/results/history_exp5_lr005.json', 'w', encoding='utf-8') as f:
    ...
    print(f"\n✅ Модель сохранена: experiments/results/model_exp5_lr005.json")
    print(f"✅ История сохранена: experiments/results/history_exp5_lr005.json")
