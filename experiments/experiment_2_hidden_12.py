"""
Эксперимент 2: Обучение модели с большим скрытым слоем (hidden_size=12)
...
def main():
    print("🧪 ЭКСПЕРИМЕНТ 2: hidden_size=12")
    print("=" * 60)
    ...
    # Создаем сеть с большим скрытым слоем
    ...
    print(f"\n🔧 Параметры:")
    print(f"   Input: 10, Hidden: 12, Output: 3")
    ...
    network.save_model('experiments/results/model_exp2_hidden12.json')
    
    with open('experiments/results/history_exp2_hidden12.json', 'w', encoding='utf-8') as f:
    ...
    print(f"\n✅ Модель сохранена: experiments/results/model_exp2_hidden12.json")
    print(f"✅ История сохранена: experiments/results/history_exp2_hidden12.json")
