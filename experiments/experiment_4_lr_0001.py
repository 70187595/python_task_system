"""
Эксперимент 4: Обучение модели с очень низким learning_rate=0.001
Цель: Проверить влияние медленного обучения на качество
"""
...
def main():
    print("🧪 ЭКСПЕРИМЕНТ 4: learning_rate=0.001")
    print("=" * 60)
    ...
    # Создаем сеть с очень низким learning rate
    ...
    print(f"   Learning rate: 0.001 (очень низкий)")
    print(f"   Epochs: 2000")
    ...
    network.save_model('experiments/results/model_exp4_lr0001.json')
    
    with open('experiments/results/history_exp4_lr0001.json', 'w', encoding='utf-8') as f:
    ...
    print(f"\n✅ Модель сохранена: experiments/results/model_exp4_lr0001.json")
    print(f"✅ История сохранена: experiments/results/history_exp4_lr0001.json")
