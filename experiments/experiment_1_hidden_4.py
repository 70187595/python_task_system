"""
Эксперимент 1: Обучение модели с маленьким скрытым слоем (hidden_size=4)
...
def main():
    print("🧪 ЭКСПЕРИМЕНТ 1: hidden_size=4")
    print("=" * 60)
    ...
    # Создаем сеть с маленьким скрытым слоем
    ...
    print(f"\n🔧 Параметры:")
    print(f"   Input: 10, Hidden: 4, Output: 3")
    ...
    network.save_model('experiments/results/model_exp1_hidden4.json')
    
    with open('experiments/results/history_exp1_hidden4.json', 'w', encoding='utf-8') as f:
    ...
    print(f"\n✅ Модель сохранена: experiments/results/model_exp1_hidden4.json")
    print(f"✅ История сохранена: experiments/results/history_exp1_hidden4.json")
